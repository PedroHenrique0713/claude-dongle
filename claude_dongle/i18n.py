...
EN = {
    ...
    # by project
    "pj.hint": "Output tokens per model · last 7 days · local count",
    ...
    "tip.claude_head": "Claude · {account}",
    "tip.codex_head": "Codex · {plan}",
    "tip.codex_week": "Week: {pct}% · resets in {time}",
    "tip.codex_seen": "read {age} ago, at Codex's last turn",
    "tip.codex_none": "Codex: no session log yet",
    "card.show": "Show",
    "show.claude": "Claude",
    "show.codex": "Codex",
    "show.both": "Both",
    "card.account": "Claude account",
    "card.codex": "Codex",
    "codex.hint": "from Codex's session logs",
    "codex.none": "no Codex session found yet",
    "codex.seen": "read {age} ago",
    "meta.token_expired": "login expired · open this account's Claude Code",
...
PT = {
    ...
    "pj.hint": "Tokens de saída por modelo · últimos 7 dias · contagem local",
    ...
    "tip.claude_head": "Claude · {account}",
    "tip.codex_head": "Codex · {plan}",
    "tip.codex_week": "Semana: {pct}% · reseta em {time}",
    "tip.codex_seen": "lido há {age}, no último uso do Codex",
    "tip.codex_none": "Codex: nenhum log de sessão ainda",
    "card.show": "Mostrar",
    "show.claude": "Claude",
    "show.codex": "Codex",
    "show.both": "Os dois",
    "card.account": "Conta do Claude",
    "card.codex": "Codex",
    "codex.hint": "dos logs de sessão do Codex",
    "codex.none": "nenhuma sessão do Codex encontrada ainda",
    "codex.seen": "lido há {age}",
    "meta.token_expired": "login expirado · abra o Claude Code desta conta",
